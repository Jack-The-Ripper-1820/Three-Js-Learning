...
// environment map to be used instead of lights in the scene (in the GUI uncheck lighting)
...
function animate() {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    labels[i].style.left = x + 'px' // use 'px' to interpret values as pixel measurements
